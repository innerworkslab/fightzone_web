            ...
            <Table class="w-full border-collapse">
                ...
                <TableBody>
                    <TableSkeletonLoader v-if="props.loading" :isLoading="props.loading"
                        :colNumber="props.columns.length + (props.actions || props.fetchSubData ? 1 : 0)"
                        :rowNumber="props.perPage || 5" />
                                ...
                                <TableCell v-for="(col, colIndex) in props.columns" :key="col.key"
                                    ...
                                    <template v-if="col.render">
                                        <div class="text-xs font-bold tracking-tight">
                                            <component
                                                v-if="typeof col.render(row, rowIndex, props.extraArgs) === 'object'"
                                ...
                                <TableCell v-if="props.actions || props.fetchSubData" class="px-4 py-4">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <button v-if="props.fetchSubData"
                                            class="p-2 rounded-lg bg-secondary text-muted-foreground transition-all
                                                   hover:bg-primary hover:text-primary-foreground shadow-sm border border-border"
                    ...
                    <TableRow v-else>
                        <TableCell :colspan="props.columns.length + (props.actions || props.fetchSubData ? 1 : 0)"
                            ...
                            <div class="flex flex-col items-center justify-center gap-2">
                                <span
                                    class="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground italic">
                                    Nothing to show yet
                                </span>
