...
import { TechniquesActions, TechniquesColumns } from "./columns";
...
const { data, loading, refresh } = TechniquesServices.useTechniques(buildApiFilter(filters.value));
...
<template>
    ...
    <DataTable :data="records" :columns="TechniquesColumns" :actions="TechniquesActions" :loading="loading"
        :extraArgs="{
            startIndex,
            router,
            dataStore,
